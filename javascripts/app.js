...
o(function(){
  ...
  // make home the current page at start
  o('#menu nav a:first').addClass('current') ;

  // attach event handlers to menu items
  o('#menu nav a').on('click', function() {
    o('#menu nav a').removeClass('current') ;
    o(this).addClass('current') ;

    o('.page').hide() ;
    var newpage = '#page-' + o(this).html().toLowerCase() ;
    o(newpage).show() ; ;
  }) ;
